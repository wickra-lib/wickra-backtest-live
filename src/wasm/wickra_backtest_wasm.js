...
export function run(open, high, low, close, volume, time, spec_json, capital) {
    ...
    try {
        ...
        const ptr5 = passArrayF64ToWasm0(time, wasm.__wbindgen_malloc);
        const len5 = WASM_VECTOR_LEN;
        const ptr6 = passStringToWasm0(spec_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len6 = WASM_VECTOR_LEN;
        const ret = wasm.run(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5, ptr6, len6, capital);
        var ptr8 = ret[0];
        var len8 = ret[1];
        if (ret[3]) {
            ptr8 = 0; len8 = 0;
...
export function run_json(request_json) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.run_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wickra_backtest_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wickra_backtest_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
